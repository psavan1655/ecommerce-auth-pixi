...
const fields = ["serviceName", "status", "delete"];
    ...
    try{
      ...
      if(getServices.data.success===true){
       ...
       if(getServices.data.data.length !==0){
         ...
         const fetchedCarousel = JSON.parse(getServices.data.data[0].services)
         console.log('fetched array of Carousel-->',fetchedCarousel.servicesArray)
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={this.state.formValues.serviceName}
                    />
