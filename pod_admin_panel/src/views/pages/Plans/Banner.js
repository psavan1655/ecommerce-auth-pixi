    ...
    try{
      ...
      if(getBannerImages.data.success===true){
       ...
       if(getBannerImages.data.data.length !==0){
         ...
         const fetchedImage = JSON.parse(getBannerImages.data.data[0].image)
         console.log('fetched array of Carousel-->',fetchedImage.image)
         if(fetchedImage.image !== undefined){
           this.setState({
